        ...
        List<Debtor> debtors = new List<Debtor>
{
      ...
      new Debtor("Pamela H. Beauchamp", DateTime.Parse("November 20, 1959"), "801-559-6347", "PamelaHBeauchamp@jourrapide.com", "3239 Tori Lane Salt Lake City, UT 84104", 6588)
        ...
        //Task2
        //var fd2 = debtors.Where(d => d.Email.EndsWith("rytha.com") || d.Email.EndsWith("dayrep.com"));
        //foreach (var d in fd2)
        //{
        ...
        //Task3
        // var fd =debtors.Where(d=>d.)


        //Task4
        //var fd4 = debtors.Where(d => d.Debt < 5000);
        //foreach (var d in fd4)
        //{
        //    Console.WriteLine(d.Name);
        //}
        ...
        //Task5
        //var fd5 = debtors.Where(d => d.Name.Length > 18 || d.PhoneNumber.Count (c => c == '2' || c == '7') >= 2).ToList();
        //foreach (var d in fd5)
        //{
        //    Console.WriteLine(d.Name);
        //}
        ...
        //Task7
        //var fd7 = debtors.Where(d => d.DateOfBirth.Month == 1 || d.DateOfBirth.Month == 2 || d.DateOfBirth.Month == 12);
        //foreach (var d in fd7)
        //{
        //    Console.WriteLine(d.Name);
        //}
        ...
        //var fd8 = debtors.Where(d => d.Debt > averageDebt)
        ...
        //Task9
        //var fd9 = debtors.Where(d => !d.PhoneNumber.Contains('8')).Select(d => new { FamilyName = d.Name.Split(' ').Last(), Age = 2024 - d.DateOfBirth.Year, d.Debt }).ToList();
        //foreach (var d in fd9)
        //{
        //    Console.WriteLine($"Familya: {d.FamilyName}, Yas: {d.Age}, Umumi borc: {d.Debt}");
        //}


        //Task11
        //var fd11 = debtors.Where(d => d.Name.GroupBy(c => c).Any(g => g.Count() >= 3)).OrderBy(d => d.Name).ToList();
        //Console.WriteLine("11) Adinda ve familyasinda hec olmasa 3 eyni herf olan borclular:");
        //foreach (var d in fd11)
        //{
        //    Console.WriteLine(d.Name);
        //}
        ...
        //Task16
        //var worldWar2Debtors = debtors.Where(d => d.DateOfBirth.Year <= 1945).ToList();
